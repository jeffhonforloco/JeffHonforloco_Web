    ...
    <section className="py-16 bg-white">
      <div className="container-lg">
        <div className="flex justify-between items-center mb-12">
          <h2 className="title-md">Featured Destinations</h2>
          <Link 
            to="/explore-travel" 
        ...
        >
          <CarouselContent className="-ml-4">
            {destinations.map(destination => (
              <CarouselItem key={destination.id} className="pl-4 md:basis-1/2 lg:basis-1/3">
                <Card className="rounded-lg overflow-hidden shadow-md hover-scale group">
          ...
          <div className="flex justify-center gap-2 mt-8">
            <CarouselPrevious className="relative static left-0 right-0 translate-y-0 bg-white hover:bg-gray-100 text-charcoal" />
            <CarouselNext className="relative static left-0 right-0 translate-y-0 bg-white hover:bg-gray-100 text-charcoal" />
          </div>
        </Carousel>
      </div>
    </section>
