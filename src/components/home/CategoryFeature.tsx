...
// Fallback images in case the API doesn't provide images
const fallbackImages = [
  ...
  'https://images.unsplash.com/photo-1603190287605-e6ade32fa852?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80'
];
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        // Filter out empty categories and limit to top 5
              ...
              >
                ...
                <div className="p-6">
                  <p className="text-gray-600">
                    {category.description || `Explore the latest ${category.name} articles and insights.`}
                  </p>
                </div>
              </Link>
            ))}
